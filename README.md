...
│   ├── webfilesapi.cs     — browser file browser (WebFileBrowserStore + per-tab sessions; download staging to %ProgramData%\CpuMon\webdl\)
