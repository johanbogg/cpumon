...
public static class Th
{
    ...
    public static void Toggle()
    {
        ...
        else { Bg = Color.FromArgb(224, 228, 236); TBg = Color.FromArgb(197, 204, 218); Card = Color.FromArgb(205, 212, 226); Brd = Color.FromArgb(148, 158, 178); Brt = Color.FromArgb(18, 22, 32); Dim = Color.FromArgb(76, 84, 102); Blu = Color.FromArgb(0, 88, 176); Grn = Color.FromArgb(0, 122, 72); Org = Color.FromArgb(155, 82, 0); Red = Color.FromArgb(174, 34, 34); Yel = Color.FromArgb(126, 98, 0); Cyan = Color.FromArgb(0, 120, 148); Mag = Color.FromArgb(112, 48, 164); }
        ThemeChanged?.Invoke();
    }
